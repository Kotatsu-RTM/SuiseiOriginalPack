...
主な変更点
・CSATCの仕様を変更
・miniHUDのATSBarの仕様を変更
・miniHUDの構図を一新しました。UV互換がありません
・ブレーキBarが横移動になりました。
===================================================*/
...
function init(par1, par2) {
    ...
    //## 加速計側のHUD ##//
    ATS_miniHUD = renderer.registerParts(new Parts(
        "ATS-P_Power","ATS-Pattern_Close","ATS-Max_Brake","ATS-Emergency_Brake",
        "ATS-NonUse_Brake","ATS-ATS_P","ATS-ATS_Power","ATS-ATS_Use"
    ));
    ATC_miniHUD = renderer.registerParts(new Parts(
        "ATC-D_ATC","ATC-ATC","ATC-Max_Brake","ATC-Emergency_Brake",
        "ATC-nonUseATC","ATC-Pattern_Teigen","ATC-Emergency_Run","ATC-ATC_Power"
    ));
    ATACS_miniHUD = renderer.registerParts(new Parts(
        "ATACS-CarD_Brake","ATACS-ATACS","ATACS-Max_Brake","ATACS-Emergency_Brake",
        "ATACS-nonUseATACS","ATACS-Pattern_Teigen","ATACS-Emergency_Run","ATACS-ATACS_Power"
    ));
    Hoan_miniHUD = renderer.registerParts(new Parts(
        "Hoan-useATS","Hoan-useATC","Hoan-useATACS","Hoan-useATO",
        "Hoan-Kosho","Hoan-Kaiho","Hoan-ChushaBrake"
    ));
    Other_miniHUD = renderer.registerParts(new Parts(
        "Other-TACS_Power","Other-TASC_Pattern","Other-TASC_Brake",
        "Other-TrainDoor","Other-HomeDoor","Other-HomeDoorLinked","Other-HomeDoorDontLinked"
    ));
    ...
    //miniHud
    mHUD_11 = renderer.registerParts(new Parts("mHUD-1_1"));
    mHUD_12 = renderer.registerParts(new Parts("mHUD-1_2"));
    mHUD_13 = renderer.registerParts(new Parts("mHUD-1_3"));
    mHUD_14 = renderer.registerParts(new Parts("mHUD-1_4"));
    mHUD_15 = renderer.registerParts(new Parts("mHUD-1_5"));
    mHUD_16 = renderer.registerParts(new Parts("mHUD-1_6"));
    mHUD_17 = renderer.registerParts(new Parts("mHUD-1_7"));
    mHUD_18 = renderer.registerParts(new Parts("mHUD-1_8"));
    mHUD_21 = renderer.registerParts(new Parts("mHUD-2_1"));
    mHUD_22 = renderer.registerParts(new Parts("mHUD-2_2"));
    mHUD_23 = renderer.registerParts(new Parts("mHUD-2_3"));
    mHUD_24 = renderer.registerParts(new Parts("mHUD-2_4"));
    mHUD_25 = renderer.registerParts(new Parts("mHUD-2_5"));
    mHUD_26 = renderer.registerParts(new Parts("mHUD-2_6"));
    mHUD_27 = renderer.registerParts(new Parts("mHUD-2_7"));
    mHUD_28 = renderer.registerParts(new Parts("mHUD-2_8"));
    mHUD_31 = renderer.registerParts(new Parts("mHUD-3_1"));
    mHUD_32 = renderer.registerParts(new Parts("mHUD-3_2"));
    mHUD_33 = renderer.registerParts(new Parts("mHUD-3_3"));
    mHUD_34 = renderer.registerParts(new Parts("mHUD-3_4"));
    mHUD_35 = renderer.registerParts(new Parts("mHUD-3_5"));
    mHUD_36 = renderer.registerParts(new Parts("mHUD-3_6"));
    mHUD_37 = renderer.registerParts(new Parts("mHUD-3_7"));
    mHUD_38 = renderer.registerParts(new Parts("mHUD-3_8"));
    //HoanHud
    HoLamp_ATS = renderer.registerParts(new Parts("HoLamp-ATS"));
    HoLamp_ATC = renderer.registerParts(new Parts("HoLamp-ATC"));
    HoLamp_ATACS = renderer.registerParts(new Parts("HoLamp-ATACS"));
    HoLamp_ATO = renderer.registerParts(new Parts("HoLamp-ATO"));
    HoLamp_Kosho = renderer.registerParts(new Parts("HoLamp_Kosho"));
    HoLamp_Kaiho = renderer.registerParts(new Parts("HoLamp_Kaiho"));
    HoLamp_ChushaBrake = renderer.registerParts(new Parts("HoLamp_ChushaBrake"));
    //OtherMiniHud
    OmHUD_11 = renderer.registerParts(new Parts("OmHUD-1_1"));
    OmHUD_12 = renderer.registerParts(new Parts("OmHUD-1_2"));
    OmHUD_13 = renderer.registerParts(new Parts("OmHUD-1_3"));
    OmHUD_14 = renderer.registerParts(new Parts("OmHUD-1_4"));
    OmHUD_15 = renderer.registerParts(new Parts("OmHUD-1_5"));
    OmHUD_16 = renderer.registerParts(new Parts("OmHUD-1_6"));
    OmHUD_17 = renderer.registerParts(new Parts("OmHUD-1_7"));
    OmHUD_21 = renderer.registerParts(new Parts("OmHUD-2_1"));
    OmHUD_22 = renderer.registerParts(new Parts("OmHUD-2_2"));
    OmHUD_23 = renderer.registerParts(new Parts("OmHUD-2_3"));
    OmHUD_24 = renderer.registerParts(new Parts("OmHUD-2_4"));
    OmHUD_25 = renderer.registerParts(new Parts("OmHUD-2_5"));
    OmHUD_26 = renderer.registerParts(new Parts("OmHUD-2_6"));
    OmHUD_27 = renderer.registerParts(new Parts("OmHUD-2_7"));

...
function init(par1, par2) {
    ...
    mHUD_14 = renderer.registerParts(new Parts("mHUD_1_4"));
    mHUD_15 = renderer.registerParts(new Parts("mHUD_1_5"));
    mHUD_16 = renderer.registerParts(new Parts("mHUD_1_6"));
    mHUD_17 = renderer.registerParts(new Parts("mHUD_1_7"));
    mHUD_18 = renderer.registerParts(new Parts("mHUD_1_8"));
    ...
    mHUD_24 = renderer.registerParts(new Parts("mHUD_2_4"));
    mHUD_25 = renderer.registerParts(new Parts("mHUD_2_5"));
    mHUD_26 = renderer.registerParts(new Parts("mHUD_2_6"));
    mHUD_27 = renderer.registerParts(new Parts("mHUD_2_7"));
    mHUD_28 = renderer.registerParts(new Parts("mHUD_2_8"));
    ...
    mHUD_34 = renderer.registerParts(new Parts("mHUD_3_4"));
    mHUD_35 = renderer.registerParts(new Parts("mHUD_3_5"));
    mHUD_36 = renderer.registerParts(new Parts("mHUD_3_6"));
    mHUD_37 = renderer.registerParts(new Parts("mHUD_3_7"));
    mHUD_38 = renderer.registerParts(new Parts("mHUD_3_8"));
    //HoanHud
